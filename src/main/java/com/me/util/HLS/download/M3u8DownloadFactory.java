package com.me.util.HLS.download;

import com.me.util.HLS.Exception.M3u8Exception;
import com.me.util.HLS.listener.DownloadListener;
import com.me.util.HLS.utils.Constant;
import com.me.util.HLS.utils.Log;
import com.me.util.HLS.utils.MediaFormat;
import com.me.util.HLS.utils.StringUtils;
...
import static com.me.util.HLS.utils.Constant.FILESEPARATOR;
            ...
            new Thread(() -> {
                ...
                while (!fixedThreadPool.isTerminated()) {
                    try {
                        ...
                        Thread.sleep(1000L);
                        /*String a = new BigDecimal(finishedCount).divide(new BigDecimal(tsSet.size()), 4, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal(100)).setScale(2, BigDecimal.ROUND_HALF_UP).toString();
                        try {
                            busSampleService.updateDownStatus(new BusSample(id, !com.hollysmart.admin.common.utils.StringUtils.equals(a, "0") && !com.hollysmart.admin.common.utils.StringUtils.equals(a, "1") ? a : "0"));
                        } catch (Exception e) {
                            log.error("保存下载进度异常", e);
                        }*/
